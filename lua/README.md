...
## Install
```bash
luarocks install voxgig-sdk-telegram-bot
```
...
```lua
-- Create
local created, _ = client:ApproveSuggestedPost():create({ name = "Example" })
...
local result, err = client:TelegramBot():load({ id = "test01" })
