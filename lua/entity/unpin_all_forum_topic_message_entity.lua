-- TelegramBot SDK UnpinAllForumTopicMessage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local UnpinAllForumTopicMessageEntity = {}
UnpinAllForumTopicMessageEntity.__index = UnpinAllForumTopicMessageEntity


function UnpinAllForumTopicMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UnpinAllForumTopicMessageEntity)
  self._name = "unpin_all_forum_topic_message"
  self._client = client
...
function UnpinAllForumTopicMessageEntity:get_name()
  return self._name
end


function UnpinAllForumTopicMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UnpinAllForumTopicMessageEntity.new(self._client, opts)
end
...
function UnpinAllForumTopicMessageEntity:mark_deleted()
  self._deleted = true
end


function UnpinAllForumTopicMessageEntity:deleted()
  return true == self._deleted
end


function UnpinAllForumTopicMessageEntity:data_set(args)
  if args ~= nil then
...
function UnpinAllForumTopicMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UnpinAllForumTopicMessageEntity:match_set(args)
  if args ~= nil then
...
function UnpinAllForumTopicMessageEntity:match_get()
...
function UnpinAllForumTopicMessageEntity:stream(action, args, callopts)
...
function UnpinAllForumTopicMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UnpinAllForumTopicMessageEntity
