...
local RemoveMyProfilePhotoEntity = {}
RemoveMyProfilePhotoEntity.__index = RemoveMyProfilePhotoEntity


function RemoveMyProfilePhotoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RemoveMyProfilePhotoEntity)
  self._name = "remove_my_profile_photo"
  self._client = client
...
function RemoveMyProfilePhotoEntity:get_name()
  return self._name
end


function RemoveMyProfilePhotoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RemoveMyProfilePhotoEntity.new(self._client, opts)
end
...
function RemoveMyProfilePhotoEntity:mark_deleted()
  self._deleted = true
end


function RemoveMyProfilePhotoEntity:deleted()
  return true == self._deleted
end


function RemoveMyProfilePhotoEntity:data_set(args)
  if args ~= nil then
...
function RemoveMyProfilePhotoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RemoveMyProfilePhotoEntity:match_set(args)
  if args ~= nil then
...
function RemoveMyProfilePhotoEntity:match_get()
...
function RemoveMyProfilePhotoEntity:stream(action, args, callopts)
...
function RemoveMyProfilePhotoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RemoveMyProfilePhotoEntity
