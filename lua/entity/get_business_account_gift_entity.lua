...
local GetBusinessAccountGiftEntity = {}
GetBusinessAccountGiftEntity.__index = GetBusinessAccountGiftEntity


function GetBusinessAccountGiftEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetBusinessAccountGiftEntity)
  self._name = "get_business_account_gift"
  self._client = client
...
function GetBusinessAccountGiftEntity:get_name()
  return self._name
end


function GetBusinessAccountGiftEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetBusinessAccountGiftEntity.new(self._client, opts)
end
...
function GetBusinessAccountGiftEntity:mark_deleted()
  self._deleted = true
end


function GetBusinessAccountGiftEntity:deleted()
  return true == self._deleted
end


function GetBusinessAccountGiftEntity:data_set(args)
  if args ~= nil then
...
function GetBusinessAccountGiftEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetBusinessAccountGiftEntity:match_set(args)
  if args ~= nil then
...
function GetBusinessAccountGiftEntity:match_get()
...
function GetBusinessAccountGiftEntity:stream(action, args, callopts)
...
function GetBusinessAccountGiftEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetBusinessAccountGiftEntity
