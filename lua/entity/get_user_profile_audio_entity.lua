...
local GetUserProfileAudioEntity = {}
GetUserProfileAudioEntity.__index = GetUserProfileAudioEntity


function GetUserProfileAudioEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetUserProfileAudioEntity)
  self._name = "get_user_profile_audio"
  self._client = client
...
function GetUserProfileAudioEntity:get_name()
  return self._name
end


function GetUserProfileAudioEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetUserProfileAudioEntity.new(self._client, opts)
end
...
function GetUserProfileAudioEntity:mark_deleted()
  self._deleted = true
end


function GetUserProfileAudioEntity:deleted()
  return true == self._deleted
end


function GetUserProfileAudioEntity:data_set(args)
  if args ~= nil then
...
function GetUserProfileAudioEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetUserProfileAudioEntity:match_set(args)
  if args ~= nil then
...
function GetUserProfileAudioEntity:match_get()
...
function GetUserProfileAudioEntity:stream(action, args, callopts)
...
function GetUserProfileAudioEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetUserProfileAudioEntity
