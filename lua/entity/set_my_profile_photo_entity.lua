...
local SetMyProfilePhotoEntity = {}
SetMyProfilePhotoEntity.__index = SetMyProfilePhotoEntity


function SetMyProfilePhotoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SetMyProfilePhotoEntity)
  self._name = "set_my_profile_photo"
  self._client = client
...
function SetMyProfilePhotoEntity:get_name()
  return self._name
end


function SetMyProfilePhotoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SetMyProfilePhotoEntity.new(self._client, opts)
end
...
function SetMyProfilePhotoEntity:mark_deleted()
  self._deleted = true
end


function SetMyProfilePhotoEntity:deleted()
  return true == self._deleted
end


function SetMyProfilePhotoEntity:data_set(args)
  if args ~= nil then
...
function SetMyProfilePhotoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SetMyProfilePhotoEntity:match_set(args)
  if args ~= nil then
...
function SetMyProfilePhotoEntity:match_get()
...
function SetMyProfilePhotoEntity:stream(action, args, callopts)
...
function SetMyProfilePhotoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SetMyProfilePhotoEntity
