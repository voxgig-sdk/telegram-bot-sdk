...
local DeleteForumTopicEntity = {}
DeleteForumTopicEntity.__index = DeleteForumTopicEntity


function DeleteForumTopicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeleteForumTopicEntity)
  self._name = "delete_forum_topic"
  self._client = client
...
function DeleteForumTopicEntity:get_name()
  return self._name
end


function DeleteForumTopicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeleteForumTopicEntity.new(self._client, opts)
end
...
function DeleteForumTopicEntity:mark_deleted()
  self._deleted = true
end


function DeleteForumTopicEntity:deleted()
  return true == self._deleted
end


function DeleteForumTopicEntity:data_set(args)
  if args ~= nil then
...
function DeleteForumTopicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeleteForumTopicEntity:match_set(args)
  if args ~= nil then
...
function DeleteForumTopicEntity:match_get()
...
function DeleteForumTopicEntity:stream(action, args, callopts)
...
function DeleteForumTopicEntity:_run_op(ctx, post_done)
  local utility = self._utility
