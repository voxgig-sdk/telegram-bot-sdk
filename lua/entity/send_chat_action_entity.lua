-- TelegramBot SDK SendChatAction entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SendChatActionEntity = {}
SendChatActionEntity.__index = SendChatActionEntity


function SendChatActionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SendChatActionEntity)
  self._name = "send_chat_action"
  self._client = client
...
function SendChatActionEntity:get_name()
  return self._name
end


function SendChatActionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SendChatActionEntity.new(self._client, opts)
end
...
function SendChatActionEntity:mark_deleted()
  self._deleted = true
end


function SendChatActionEntity:deleted()
  return true == self._deleted
end


function SendChatActionEntity:data_set(args)
  if args ~= nil then
...
function SendChatActionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SendChatActionEntity:match_set(args)
  if args ~= nil then
...
function SendChatActionEntity:match_get()
...
function SendChatActionEntity:stream(action, args, callopts)
...
---@param reqdata SendChatActionCreateData
---@param ctrl? table
---@return SendChatAction
---@return string? err
function SendChatActionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SendChatActionEntity:_run_op(ctx, post_done)
  local utility = self._utility
