...
local ApproveSuggestedPostEntity = {}
ApproveSuggestedPostEntity.__index = ApproveSuggestedPostEntity


function ApproveSuggestedPostEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApproveSuggestedPostEntity)
  self._name = "approve_suggested_post"
  self._client = client
...
function ApproveSuggestedPostEntity:get_name()
  return self._name
end


function ApproveSuggestedPostEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApproveSuggestedPostEntity.new(self._client, opts)
end
...
function ApproveSuggestedPostEntity:mark_deleted()
  self._deleted = true
end


function ApproveSuggestedPostEntity:deleted()
  return true == self._deleted
end


function ApproveSuggestedPostEntity:data_set(args)
  if args ~= nil then
...
function ApproveSuggestedPostEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApproveSuggestedPostEntity:match_set(args)
  if args ~= nil then
...
function ApproveSuggestedPostEntity:match_get()
...
function ApproveSuggestedPostEntity:stream(action, args, callopts)
...
function ApproveSuggestedPostEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApproveSuggestedPostEntity
