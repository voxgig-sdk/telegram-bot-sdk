...
function runner.env_override(m)
  local live = runner.getenv("TELEGRAM_BOT_TEST_LIVE")
  local override = runner.getenv("TELEGRAM_BOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TELEGRAM_BOT_TEST_EXPLAIN")
