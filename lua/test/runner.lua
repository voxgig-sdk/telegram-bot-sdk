...
function runner.env_override(m)
  local live = runner.getenv("TELEGRAMBOT_TEST_LIVE")
  local override = runner.getenv("TELEGRAMBOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TELEGRAMBOT_TEST_EXPLAIN")
