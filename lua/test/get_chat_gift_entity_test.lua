...
describe("GetChatGiftEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TELEGRAM_BOT_TEST_GET_CHAT_GIFT_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    get_chat_gift_ref01_data = helpers.to_map(type(get_chat_gift_ref01_data_result) == 'table' and get_chat_gift_ref01_data_result.data_get and get_chat_gift_ref01_data_result:data_get() or get_chat_gift_ref01_data_result)
...
function get_chat_gift_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TELEGRAM_BOT_TEST_GET_CHAT_GIFT_ENTID")
