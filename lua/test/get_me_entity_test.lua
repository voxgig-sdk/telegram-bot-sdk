...
describe("GetMeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_GET_ME_ENTID JSON to run live")
      return
    end
...
function get_me_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TELEGRAMBOT_TEST_GET_ME_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["TELEGRAMBOT_TEST_GET_ME_ENTID"])
