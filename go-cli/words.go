...
func registerSDKWords(r *eng.Registry, client *sdk.TelegramBotSDK) {
...
func runOp(client *sdk.TelegramBotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
