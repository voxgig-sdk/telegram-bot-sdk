...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/telegram-bot` | `npm install @voxgig-sdk/telegram-bot` |
| Python | `voxgig-sdk-telegram-bot` | `pip install voxgig-sdk-telegram-bot` |
| PHP | `voxgig-sdk/telegram-bot` | `composer require voxgig-sdk/telegram-bot` |
| Golang | `github.com/voxgig-sdk/telegram-bot-sdk/go` | `go get github.com/voxgig-sdk/telegram-bot-sdk/go` |
| Ruby | `voxgig-sdk-telegram-bot` | `gem install voxgig-sdk-telegram-bot` |
| Lua | `voxgig-sdk-telegram-bot` | `luarocks install voxgig-sdk-telegram-bot` |
