...
class GetMeDirectTest extends TestCase
{
    public function test_direct_load_get_me(): void
    {
        $setup = get_me_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_me", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
