...
class GetBusinessAccountGiftEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TELEGRAM_BOT_TEST_GET_BUSINESS_ACCOUNT_GIFT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $get_business_account_gift_ref01_data = Helpers::to_map(is_object($get_business_account_gift_ref01_data_result) && method_exists($get_business_account_gift_ref01_data_result, 'data_get') ? $get_business_account_gift_ref01_data_result->data_get() : $get_business_account_gift_ref01_data_result);
...
function get_business_account_gift_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TELEGRAM_BOT_TEST_GET_BUSINESS_ACCOUNT_GIFT_ENTID");
