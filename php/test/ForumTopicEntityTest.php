...
class ForumTopicEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_FORUM_TOPIC_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function forum_topic_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TELEGRAMBOT_TEST_FORUM_TOPIC_ENTID");
