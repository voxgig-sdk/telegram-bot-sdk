...
// TelegramBot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TelegramBotSDK::test)
...
{
    private const SDK_CLASS = 'TelegramBotSDK';
    ...
    private const SDK_BASE = 'telegrambot_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../telegrambot_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
