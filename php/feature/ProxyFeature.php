...
class TelegramBotProxyFeature extends TelegramBotBaseFeature
{
    ...
    public function init(TelegramBotContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TelegramBotContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
