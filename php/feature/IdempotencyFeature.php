...
// TelegramBot SDK idempotency feature
...
class TelegramBotIdempotencyFeature extends TelegramBotBaseFeature
{
    ...
    private function _mutating(TelegramBotContext $ctx): bool
    {
