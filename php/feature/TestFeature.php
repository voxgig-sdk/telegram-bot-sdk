...
// TelegramBot SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TelegramBotTestFeature extends TelegramBotBaseFeature
{
    ...
    public function init(TelegramBotContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TelegramBotContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TelegramBotParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TelegramBotContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TelegramBotContext $ctx, $op, $args): array
    {
