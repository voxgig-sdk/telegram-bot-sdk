...
// TelegramBot SDK timeout feature
...
class TelegramBotTimeoutFeature extends TelegramBotBaseFeature
{
    ...
    private function _with_timeout(TelegramBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TelegramBotContext $_ctx, float $ms): void
    {
        $client = $this->client;
