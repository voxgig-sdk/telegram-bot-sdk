...
// TelegramBot SDK DeleteForumTopic entity
...
class DeleteForumTopicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeleteForumTopicEntity($this->_client, $opts);
    }

    /**
     * @param DeleteForumTopic|array $args DeleteForumTopic data (assoc-array) to store.
     */
    ...
    /**
     * @return DeleteForumTopic|array The current DeleteForumTopic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeleteForumTopic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeleteForumTopic fields).
     */
    ...
    /**
     * Create a new DeleteForumTopic.
     *
     * @param DeleteForumTopicCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeleteForumTopicCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeleteForumTopic|array The created DeleteForumTopic as an assoc-array at the
