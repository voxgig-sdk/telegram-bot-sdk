...
class UnpinAllForumTopicMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "unpin_all_forum_topic_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UnpinAllForumTopicMessageEntity($this->_client, $opts);
    }

    /**
     * @param UnpinAllForumTopicMessage|array $args UnpinAllForumTopicMessage data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = TelegramBotHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return UnpinAllForumTopicMessage|array The current UnpinAllForumTopicMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UnpinAllForumTopicMessage fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = TelegramBotHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of UnpinAllForumTopicMessage fields).
     */
    ...
    /**
     * Create a new UnpinAllForumTopicMessage.
     *
     * @param UnpinAllForumTopicMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UnpinAllForumTopicMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UnpinAllForumTopicMessage|array The created UnpinAllForumTopicMessage as an assoc-array at the
