...
class ForumTopicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ForumTopicEntity($this->_client, $opts);
    }

    /**
     * @param ForumTopic|array $args ForumTopic data (assoc-array) to store.
     */
    ...
    /**
     * @return ForumTopic|array The current ForumTopic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ForumTopic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ForumTopic fields).
     */
     ...
     *
     * @param ForumTopicCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ForumTopicCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ForumTopic|array The created ForumTopic as an assoc-array at the
