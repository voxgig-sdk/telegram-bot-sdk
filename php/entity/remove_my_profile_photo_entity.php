...
// TelegramBot SDK RemoveMyProfilePhoto entity
...
class RemoveMyProfilePhotoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "remove_my_profile_photo";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new RemoveMyProfilePhotoEntity($this->_client, $opts);
    }

    /**
     * @param RemoveMyProfilePhoto|array $args RemoveMyProfilePhoto data (assoc-array) to store.
     */
    ...
    /**
     * @return RemoveMyProfilePhoto|array The current RemoveMyProfilePhoto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RemoveMyProfilePhoto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RemoveMyProfilePhoto fields).
     */
    ...
    /**
     * Create a new RemoveMyProfilePhoto.
     *
     * @param RemoveMyProfilePhotoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RemoveMyProfilePhotoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RemoveMyProfilePhoto|array The created RemoveMyProfilePhoto as an assoc-array at the
