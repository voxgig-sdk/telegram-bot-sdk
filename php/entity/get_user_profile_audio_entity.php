...
// TelegramBot SDK GetUserProfileAudio entity
...
class GetUserProfileAudioEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_user_profile_audio";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetUserProfileAudioEntity($this->_client, $opts);
    }

    /**
     * @param GetUserProfileAudio|array $args GetUserProfileAudio data (assoc-array) to store.
     */
    ...
    /**
     * @return GetUserProfileAudio|array The current GetUserProfileAudio data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetUserProfileAudio fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetUserProfileAudio fields).
     */
    ...
    /**
     * Create a new GetUserProfileAudio.
     *
     * @param GetUserProfileAudioCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GetUserProfileAudioCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetUserProfileAudio|array The created GetUserProfileAudio as an assoc-array at the
