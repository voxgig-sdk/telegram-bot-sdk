...
// TelegramBot SDK GetBusinessAccountGift entity
...
class GetBusinessAccountGiftEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_business_account_gift";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetBusinessAccountGiftEntity($this->_client, $opts);
    }

    /**
     * @param GetBusinessAccountGift|array $args GetBusinessAccountGift data (assoc-array) to store.
     */
    ...
    /**
     * @return GetBusinessAccountGift|array The current GetBusinessAccountGift data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetBusinessAccountGift fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetBusinessAccountGift fields).
     */
    ...
    /**
     * Create a new GetBusinessAccountGift.
     *
     * @param GetBusinessAccountGiftCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GetBusinessAccountGiftCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetBusinessAccountGift|array The created GetBusinessAccountGift as an assoc-array at the
