...
class PromoteChatMemberEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "promote_chat_member";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PromoteChatMemberEntity($this->_client, $opts);
    }

    /**
     * @param PromoteChatMember|array $args PromoteChatMember data (assoc-array) to store.
     */
    ...
    /**
     * @return PromoteChatMember|array The current PromoteChatMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PromoteChatMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PromoteChatMember fields).
     */
     ...
     *
     * @param PromoteChatMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PromoteChatMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PromoteChatMember|array The created PromoteChatMember as an assoc-array at the
