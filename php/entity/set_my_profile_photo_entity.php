...
// TelegramBot SDK SetMyProfilePhoto entity
...
class SetMyProfilePhotoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "set_my_profile_photo";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SetMyProfilePhotoEntity($this->_client, $opts);
    }

    /**
     * @param SetMyProfilePhoto|array $args SetMyProfilePhoto data (assoc-array) to store.
     */
    ...
    /**
     * @return SetMyProfilePhoto|array The current SetMyProfilePhoto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SetMyProfilePhoto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SetMyProfilePhoto fields).
     */
    ...
    /**
     * Create a new SetMyProfilePhoto.
     *
     * @param SetMyProfilePhotoCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SetMyProfilePhotoCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SetMyProfilePhoto|array The created SetMyProfilePhoto as an assoc-array at the
