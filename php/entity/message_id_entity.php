...
class MessageIdEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MessageIdEntity($this->_client, $opts);
    }

    /**
     * @param MessageId|array $args MessageId data (assoc-array) to store.
     */
    ...
    /**
     * @return MessageId|array The current MessageId data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MessageId fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MessageId fields).
     */
     ...
     *
     * @param MessageIdCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MessageIdCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MessageId|array The created MessageId as an assoc-array at the
