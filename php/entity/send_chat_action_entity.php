...
class SendChatActionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SendChatActionEntity($this->_client, $opts);
    }

    /**
     * @param SendChatAction|array $args SendChatAction data (assoc-array) to store.
     */
    ...
    /**
     * @return SendChatAction|array The current SendChatAction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SendChatAction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SendChatAction fields).
     */
     ...
     *
     * @param SendChatActionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SendChatActionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SendChatAction|array The created SendChatAction as an assoc-array at the
