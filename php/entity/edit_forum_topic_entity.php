...
// TelegramBot SDK EditForumTopic entity
...
class EditForumTopicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EditForumTopicEntity($this->_client, $opts);
    }

    /**
     * @param EditForumTopic|array $args EditForumTopic data (assoc-array) to store.
     */
    ...
    /**
     * @return EditForumTopic|array The current EditForumTopic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EditForumTopic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EditForumTopic fields).
     */
     ...
     *
     * @param EditForumTopicCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EditForumTopicCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EditForumTopic|array The created EditForumTopic as an assoc-array at the
