...
// TelegramBot SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class TelegramBotTransformResponse
{
    public static function call(TelegramBotContext $ctx): mixed
    {
        ...
        $transform = TelegramBotHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
