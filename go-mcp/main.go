// Command TelegramBot-mcp is an MCP server exposing the TelegramBot
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TelegramBot_list  — list records of an entity
//	TelegramBot_load  — load a single record of an entity
//
