...
from telegrambot_sdk.core.helpers import get_ctx_prop, to_map
...
class TelegramBotContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, TelegramBotSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TelegramBotResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TelegramBotResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return TelegramBotError(code, msg, self)
