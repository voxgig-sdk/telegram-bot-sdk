...
class DeclineSuggestedPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeclineSuggestedPostEntity(self._client, opts)
    ...
    def data_get(self) -> DeclineSuggestedPost:
    ...
    def match_get(self) -> DeclineSuggestedPost:
    ...
    def create(self, reqdata: DeclineSuggestedPostCreateData, ctrl=None) -> DeclineSuggestedPost:
        utility = self._utility
