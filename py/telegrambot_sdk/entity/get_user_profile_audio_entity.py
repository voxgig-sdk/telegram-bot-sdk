...
class GetUserProfileAudioEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetUserProfileAudioEntity(self._client, opts)
    ...
    def data_get(self) -> GetUserProfileAudio:
    ...
    def match_get(self) -> GetUserProfileAudio:
    ...
    def create(self, reqdata: GetUserProfileAudioCreateData, ctrl=None) -> GetUserProfileAudio:
        utility = self._utility
