...
class MessageIdEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MessageIdEntity(self._client, opts)
    ...
    def create(self, reqdata: MessageIdCreateData, ctrl=None) -> MessageId:
        utility = self._utility
