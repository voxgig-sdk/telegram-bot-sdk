...
class ForumTopicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ForumTopicEntity(self._client, opts)
    ...
    def create(self, reqdata: ForumTopicCreateData, ctrl=None) -> ForumTopic:
        utility = self._utility
