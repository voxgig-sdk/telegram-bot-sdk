...
class ApproveSuggestedPostEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApproveSuggestedPostEntity(self._client, opts)
    ...
    def data_get(self) -> ApproveSuggestedPost:
    ...
    def match_get(self) -> ApproveSuggestedPost:
    ...
    def create(self, reqdata: ApproveSuggestedPostCreateData, ctrl=None) -> ApproveSuggestedPost:
        utility = self._utility
