    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TELEGRAMBOT_TEST_DELETE_FORUM_TOPIC_ENTID JSON to run live")
        client = setup["client"]
...
def _delete_forum_topic_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "TELEGRAMBOT_TEST_DELETE_FORUM_TOPIC_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("TELEGRAMBOT_TEST_DELETE_FORUM_TOPIC_ENTID"))
