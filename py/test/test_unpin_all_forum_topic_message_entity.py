    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TELEGRAMBOT_TEST_UNPIN_ALL_FORUM_TOPIC_MESSAGE_ENTID JSON to run live")
        client = setup["client"]
...
def _unpin_all_forum_topic_message_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "TELEGRAMBOT_TEST_UNPIN_ALL_FORUM_TOPIC_MESSAGE_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("TELEGRAMBOT_TEST_UNPIN_ALL_FORUM_TOPIC_MESSAGE_ENTID"))
