    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TELEGRAMBOT_TEST_APPROVE_SUGGESTED_POST_ENTID JSON to run live")
        client = setup["client"]
...
def _approve_suggested_post_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "TELEGRAMBOT_TEST_APPROVE_SUGGESTED_POST_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("TELEGRAMBOT_TEST_APPROVE_SUGGESTED_POST_ENTID"))
