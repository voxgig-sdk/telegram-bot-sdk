# TelegramBot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TelegramBotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TelegramBotSDK(...) and TelegramBotSDK.test(...) become
#      TelegramBotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "telegrambot_sdk"
_SDK_CLASS = "TelegramBotSDK"
...
_ENTITIES = {
    ...
    "GetBusinessAccountGift": "get_business_account_gift",
    "GetChatGift": "get_chat_gift",
    "GetMe": "get_me",
    "GetUserGift": "get_user_gift",
    "GetUserProfileAudio": "get_user_profile_audio",
    "Message": "message",
    ...
    "UnpinAllForumTopicMessage": "unpin_all_forum_topic_message",
    "Update": "update",
}
