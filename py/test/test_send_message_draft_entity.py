    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set TELEGRAMBOT_TEST_SEND_MESSAGE_DRAFT_ENTID JSON to run live")
        client = setup["client"]
...
def _send_message_draft_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "TELEGRAMBOT_TEST_SEND_MESSAGE_DRAFT_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("TELEGRAMBOT_TEST_SEND_MESSAGE_DRAFT_ENTID"))
