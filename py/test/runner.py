...
class TelegramBotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TelegramBotTestRunner.getenv("TELEGRAMBOT_TEST_LIVE")
        override = TelegramBotTestRunner.getenv("TELEGRAMBOT_TEST_OVERRIDE")
        ...
        explain = TelegramBotTestRunner.getenv("TELEGRAMBOT_TEST_EXPLAIN")
