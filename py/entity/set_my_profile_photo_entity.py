...
class SetMyProfilePhotoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SetMyProfilePhotoEntity(self._client, opts)
    ...
    def data_get(self) -> SetMyProfilePhoto:
    ...
    def match_get(self) -> SetMyProfilePhoto:
    ...
    def create(self, reqdata: SetMyProfilePhotoCreateData, ctrl=None) -> SetMyProfilePhoto:
        utility = self._utility
