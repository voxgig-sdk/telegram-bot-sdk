...
class GetBusinessAccountGiftEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetBusinessAccountGiftEntity(self._client, opts)
    ...
    def data_get(self) -> GetBusinessAccountGift:
    ...
    def match_get(self) -> GetBusinessAccountGift:
    ...
    def create(self, reqdata: GetBusinessAccountGiftCreateData, ctrl=None) -> GetBusinessAccountGift:
        utility = self._utility
