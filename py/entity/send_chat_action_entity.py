...
class SendChatActionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SendChatActionEntity(self._client, opts)
    ...
    def data_get(self) -> SendChatAction:
    ...
    def match_get(self) -> SendChatAction:
    ...
    def create(self, reqdata: SendChatActionCreateData, ctrl=None) -> SendChatAction:
