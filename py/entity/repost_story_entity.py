...
class RepostStoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RepostStoryEntity(self._client, opts)
    ...
    def match_get(self) -> RepostStory:
    ...
    def create(self, reqdata: RepostStoryCreateData, ctrl=None) -> RepostStory:
