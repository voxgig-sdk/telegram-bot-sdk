...
class GetChatGiftEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetChatGiftEntity(self._client, opts)
    ...
    def match_get(self) -> GetChatGift:
    ...
    def create(self, reqdata: GetChatGiftCreateData, ctrl=None) -> GetChatGift:
        utility = self._utility
