...
class SendMessageDraftEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SendMessageDraftEntity(self._client, opts)
    ...
    def data_get(self) -> SendMessageDraft:
    ...
    def match_get(self) -> SendMessageDraft:
    ...
    def create(self, reqdata: SendMessageDraftCreateData, ctrl=None) -> SendMessageDraft:
