...
class DeleteForumTopicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DeleteForumTopicEntity(self._client, opts)
    ...
    def data_get(self) -> DeleteForumTopic:
    ...
    def match_get(self) -> DeleteForumTopic:
    ...
    def create(self, reqdata: DeleteForumTopicCreateData, ctrl=None) -> DeleteForumTopic:
        utility = self._utility
