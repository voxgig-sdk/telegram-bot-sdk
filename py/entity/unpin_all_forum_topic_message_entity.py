...
class UnpinAllForumTopicMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UnpinAllForumTopicMessageEntity(self._client, opts)
    ...
    def data_get(self) -> UnpinAllForumTopicMessage:
    ...
    def match_get(self) -> UnpinAllForumTopicMessage:
    ...
    def create(self, reqdata: UnpinAllForumTopicMessageCreateData, ctrl=None) -> UnpinAllForumTopicMessage:
