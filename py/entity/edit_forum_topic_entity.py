...
class EditForumTopicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EditForumTopicEntity(self._client, opts)
    ...
    def data_get(self) -> EditForumTopic:
    ...
    def match_get(self) -> EditForumTopic:
    ...
    def create(self, reqdata: EditForumTopicCreateData, ctrl=None) -> EditForumTopic:
