...
class RemoveMyProfilePhotoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RemoveMyProfilePhotoEntity(self._client, opts)
    ...
    def data_get(self) -> RemoveMyProfilePhoto:
    ...
    def match_get(self) -> RemoveMyProfilePhoto:
    ...
    def create(self, reqdata: RemoveMyProfilePhotoCreateData, ctrl=None) -> RemoveMyProfilePhoto:
