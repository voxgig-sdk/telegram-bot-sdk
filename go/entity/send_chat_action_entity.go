...
type SendChatActionEntity struct {
	name    string
...
func NewSendChatActionEntity(client *core.TelegramBotSDK, entopts map[string]any) *SendChatActionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SendChatActionEntity) GetName() string { return e.name }
...
func (e *SendChatActionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SendChatActionEntity) Deleted() bool {
	return e.deleted
}


func (e *SendChatActionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSendChatActionEntity(e.client, opts)
}

func (e *SendChatActionEntity) Data(args ...any) any {
...
func (e *SendChatActionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SendChatAction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SendChatActionEntity) DataTyped(data ...SendChatAction) SendChatAction {
	if len(data) > 0 {
		return typedFrom[SendChatAction](e.Data(asMap(data[0])))
	}
	return typedFrom[SendChatAction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SendChatAction (all fields
// optional at the wire level).
func (e *SendChatActionEntity) MatchTyped(match ...SendChatAction) SendChatAction {
	if len(match) > 0 {
		return typedFrom[SendChatAction](e.Match(asMap(match[0])))
	}
	return typedFrom[SendChatAction](e.Match())
}
...
func (e *SendChatActionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SendChatActionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SendChatActionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SendChatActionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SendChatActionCreateData and returns an SendChatAction. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SendChatActionEntity) CreateTyped(reqdata SendChatActionCreateData, ctrl map[string]any) (SendChatAction, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SendChatAction{}, err
	}
	return typedFrom[SendChatAction](res), nil
}



func (e *SendChatActionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SendChatActionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SendChatActionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
