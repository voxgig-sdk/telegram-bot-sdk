...
type SetMyProfilePhotoEntity struct {
	name    string
...
func NewSetMyProfilePhotoEntity(client *core.TelegramBotSDK, entopts map[string]any) *SetMyProfilePhotoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SetMyProfilePhotoEntity) GetName() string { return e.name }
...
func (e *SetMyProfilePhotoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SetMyProfilePhotoEntity) Deleted() bool {
	return e.deleted
}


func (e *SetMyProfilePhotoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSetMyProfilePhotoEntity(e.client, opts)
}

func (e *SetMyProfilePhotoEntity) Data(args ...any) any {
...
func (e *SetMyProfilePhotoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SetMyProfilePhoto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SetMyProfilePhotoEntity) DataTyped(data ...SetMyProfilePhoto) SetMyProfilePhoto {
	if len(data) > 0 {
		return typedFrom[SetMyProfilePhoto](e.Data(asMap(data[0])))
	}
	return typedFrom[SetMyProfilePhoto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SetMyProfilePhoto (all fields
// optional at the wire level).
func (e *SetMyProfilePhotoEntity) MatchTyped(match ...SetMyProfilePhoto) SetMyProfilePhoto {
	if len(match) > 0 {
		return typedFrom[SetMyProfilePhoto](e.Match(asMap(match[0])))
	}
	return typedFrom[SetMyProfilePhoto](e.Match())
}
...
func (e *SetMyProfilePhotoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SetMyProfilePhotoEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SetMyProfilePhotoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SetMyProfilePhotoEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SetMyProfilePhotoCreateData and returns an SetMyProfilePhoto. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SetMyProfilePhotoEntity) CreateTyped(reqdata SetMyProfilePhotoCreateData, ctrl map[string]any) (SetMyProfilePhoto, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SetMyProfilePhoto{}, err
	}
	return typedFrom[SetMyProfilePhoto](res), nil
}



func (e *SetMyProfilePhotoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SetMyProfilePhotoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SetMyProfilePhotoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
