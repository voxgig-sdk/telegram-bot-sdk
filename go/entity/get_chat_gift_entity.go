...
func NewGetChatGiftEntity(client *core.TelegramBotSDK, entopts map[string]any) *GetChatGiftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetChatGiftEntity) GetName() string { return e.name }
...
func (e *GetChatGiftEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetChatGiftEntity) Deleted() bool {
	return e.deleted
}


func (e *GetChatGiftEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetChatGiftEntity(e.client, opts)
}

func (e *GetChatGiftEntity) Data(args ...any) any {
...
func (e *GetChatGiftEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetChatGift; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetChatGiftEntity) DataTyped(data ...GetChatGift) GetChatGift {
	if len(data) > 0 {
		return typedFrom[GetChatGift](e.Data(asMap(data[0])))
	}
	return typedFrom[GetChatGift](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetChatGift (all fields
// optional at the wire level).
func (e *GetChatGiftEntity) MatchTyped(match ...GetChatGift) GetChatGift {
	if len(match) > 0 {
		return typedFrom[GetChatGift](e.Match(asMap(match[0])))
	}
	return typedFrom[GetChatGift](e.Match())
}
...
func (e *GetChatGiftEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetChatGiftEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GetChatGiftEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GetChatGiftEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetChatGiftCreateData and returns an GetChatGift. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GetChatGiftEntity) CreateTyped(reqdata GetChatGiftCreateData, ctrl map[string]any) (GetChatGift, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GetChatGift{}, err
	}
	return typedFrom[GetChatGift](res), nil
}



func (e *GetChatGiftEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetChatGiftEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetChatGiftEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
