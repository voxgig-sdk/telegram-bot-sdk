...
type DeleteForumTopicEntity struct {
	name    string
...
func NewDeleteForumTopicEntity(client *core.TelegramBotSDK, entopts map[string]any) *DeleteForumTopicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeleteForumTopicEntity) GetName() string { return e.name }
...
func (e *DeleteForumTopicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeleteForumTopicEntity) Deleted() bool {
	return e.deleted
}


func (e *DeleteForumTopicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeleteForumTopicEntity(e.client, opts)
}

func (e *DeleteForumTopicEntity) Data(args ...any) any {
...
func (e *DeleteForumTopicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeleteForumTopic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeleteForumTopicEntity) DataTyped(data ...DeleteForumTopic) DeleteForumTopic {
	if len(data) > 0 {
		return typedFrom[DeleteForumTopic](e.Data(asMap(data[0])))
	}
	return typedFrom[DeleteForumTopic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeleteForumTopic (all fields
// optional at the wire level).
func (e *DeleteForumTopicEntity) MatchTyped(match ...DeleteForumTopic) DeleteForumTopic {
	if len(match) > 0 {
		return typedFrom[DeleteForumTopic](e.Match(asMap(match[0])))
	}
	return typedFrom[DeleteForumTopic](e.Match())
}
...
func (e *DeleteForumTopicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeleteForumTopicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeleteForumTopicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DeleteForumTopicEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeleteForumTopicCreateData and returns an DeleteForumTopic. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DeleteForumTopicEntity) CreateTyped(reqdata DeleteForumTopicCreateData, ctrl map[string]any) (DeleteForumTopic, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DeleteForumTopic{}, err
	}
	return typedFrom[DeleteForumTopic](res), nil
}



func (e *DeleteForumTopicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeleteForumTopicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeleteForumTopicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
