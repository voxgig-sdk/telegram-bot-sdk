...
type PromoteChatMemberEntity struct {
	name    string
...
func NewPromoteChatMemberEntity(client *core.TelegramBotSDK, entopts map[string]any) *PromoteChatMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PromoteChatMemberEntity) GetName() string { return e.name }
...
func (e *PromoteChatMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PromoteChatMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *PromoteChatMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPromoteChatMemberEntity(e.client, opts)
}

func (e *PromoteChatMemberEntity) Data(args ...any) any {
...
func (e *PromoteChatMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PromoteChatMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PromoteChatMemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PromoteChatMemberEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *PromoteChatMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PromoteChatMemberEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PromoteChatMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
