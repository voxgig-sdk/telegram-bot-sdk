...
func NewGetUserGiftEntity(client *core.TelegramBotSDK, entopts map[string]any) *GetUserGiftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetUserGiftEntity) GetName() string { return e.name }
...
func (e *GetUserGiftEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetUserGiftEntity) Deleted() bool {
	return e.deleted
}


func (e *GetUserGiftEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetUserGiftEntity(e.client, opts)
}

func (e *GetUserGiftEntity) Data(args ...any) any {
...
func (e *GetUserGiftEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetUserGift; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetUserGiftEntity) DataTyped(data ...GetUserGift) GetUserGift {
	if len(data) > 0 {
		return typedFrom[GetUserGift](e.Data(asMap(data[0])))
	}
	return typedFrom[GetUserGift](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetUserGift (all fields
// optional at the wire level).
func (e *GetUserGiftEntity) MatchTyped(match ...GetUserGift) GetUserGift {
	if len(match) > 0 {
		return typedFrom[GetUserGift](e.Match(asMap(match[0])))
	}
	return typedFrom[GetUserGift](e.Match())
}
...
func (e *GetUserGiftEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetUserGiftEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *GetUserGiftEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GetUserGiftEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetUserGiftCreateData and returns an GetUserGift. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GetUserGiftEntity) CreateTyped(reqdata GetUserGiftCreateData, ctrl map[string]any) (GetUserGift, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return GetUserGift{}, err
	}
	return typedFrom[GetUserGift](res), nil
}



func (e *GetUserGiftEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetUserGiftEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetUserGiftEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
