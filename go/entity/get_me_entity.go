...
func NewGetMeEntity(client *core.TelegramBotSDK, entopts map[string]any) *GetMeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetMeEntity) Deleted() bool {
	return e.deleted
}


func (e *GetMeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetMeEntity(e.client, opts)
}

func (e *GetMeEntity) Data(args ...any) any {
...
func (e *GetMeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetMe; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetMeEntity) DataTyped(data ...GetMe) GetMe {
	if len(data) > 0 {
		return typedFrom[GetMe](e.Data(asMap(data[0])))
	}
	return typedFrom[GetMe](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetMe (all fields
// optional at the wire level).
func (e *GetMeEntity) MatchTyped(match ...GetMe) GetMe {
	if len(match) > 0 {
		return typedFrom[GetMe](e.Match(asMap(match[0])))
	}
...
func (e *GetMeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// GetMeCreateData and returns an GetMe. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *GetMeEntity) CreateTyped(reqdata GetMeCreateData, ctrl map[string]any) (GetMe, error) {
...
func (e *GetMeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetMeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetMeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
