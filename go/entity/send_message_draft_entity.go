...
type SendMessageDraftEntity struct {
	name    string
...
func NewSendMessageDraftEntity(client *core.TelegramBotSDK, entopts map[string]any) *SendMessageDraftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SendMessageDraftEntity) GetName() string { return e.name }
...
func (e *SendMessageDraftEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SendMessageDraftEntity) Deleted() bool {
	return e.deleted
}


func (e *SendMessageDraftEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSendMessageDraftEntity(e.client, opts)
}

func (e *SendMessageDraftEntity) Data(args ...any) any {
...
func (e *SendMessageDraftEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SendMessageDraft; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SendMessageDraftEntity) DataTyped(data ...SendMessageDraft) SendMessageDraft {
	if len(data) > 0 {
		return typedFrom[SendMessageDraft](e.Data(asMap(data[0])))
	}
	return typedFrom[SendMessageDraft](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SendMessageDraft (all fields
// optional at the wire level).
func (e *SendMessageDraftEntity) MatchTyped(match ...SendMessageDraft) SendMessageDraft {
	if len(match) > 0 {
		return typedFrom[SendMessageDraft](e.Match(asMap(match[0])))
	}
	return typedFrom[SendMessageDraft](e.Match())
}
...
func (e *SendMessageDraftEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SendMessageDraftEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *SendMessageDraftEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *SendMessageDraftEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SendMessageDraftCreateData and returns an SendMessageDraft. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *SendMessageDraftEntity) CreateTyped(reqdata SendMessageDraftCreateData, ctrl map[string]any) (SendMessageDraft, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return SendMessageDraft{}, err
	}
	return typedFrom[SendMessageDraft](res), nil
}



func (e *SendMessageDraftEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SendMessageDraftEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SendMessageDraftEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
