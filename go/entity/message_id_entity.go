...
func NewMessageIdEntity(client *core.TelegramBotSDK, entopts map[string]any) *MessageIdEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MessageIdEntity) GetName() string { return e.name }
...
func (e *MessageIdEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MessageIdEntity) Deleted() bool {
	return e.deleted
}


func (e *MessageIdEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMessageIdEntity(e.client, opts)
}

func (e *MessageIdEntity) Data(args ...any) any {
...
func (e *MessageIdEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MessageId; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MessageIdEntity) DataTyped(data ...MessageId) MessageId {
	if len(data) > 0 {
		return typedFrom[MessageId](e.Data(asMap(data[0])))
	}
	return typedFrom[MessageId](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MessageId (all fields
// optional at the wire level).
func (e *MessageIdEntity) MatchTyped(match ...MessageId) MessageId {
	if len(match) > 0 {
		return typedFrom[MessageId](e.Match(asMap(match[0])))
	}
	return typedFrom[MessageId](e.Match())
}
...
func (e *MessageIdEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MessageIdEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MessageIdEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MessageIdEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MessageIdCreateData and returns an MessageId. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MessageIdEntity) CreateTyped(reqdata MessageIdCreateData, ctrl map[string]any) (MessageId, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return MessageId{}, err
	}
	return typedFrom[MessageId](res), nil
}



func (e *MessageIdEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MessageIdEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MessageIdEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
