...
type GetBusinessAccountGiftEntity struct {
	name    string
...
func NewGetBusinessAccountGiftEntity(client *core.TelegramBotSDK, entopts map[string]any) *GetBusinessAccountGiftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &GetBusinessAccountGiftEntity{
...
func (e *GetBusinessAccountGiftEntity) GetName() string { return e.name }
...
func (e *GetBusinessAccountGiftEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetBusinessAccountGiftEntity) Deleted() bool {
	return e.deleted
}


func (e *GetBusinessAccountGiftEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetBusinessAccountGiftEntity(e.client, opts)
}

func (e *GetBusinessAccountGiftEntity) Data(args ...any) any {
...
func (e *GetBusinessAccountGiftEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetBusinessAccountGiftEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetBusinessAccountGiftEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GetBusinessAccountGiftEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetBusinessAccountGiftEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetBusinessAccountGiftEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetBusinessAccountGiftEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
