...
func NewUpdateEntity(client *core.TelegramBotSDK, entopts map[string]any) *UpdateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UpdateEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// UpdateCreateData and returns an Update. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UpdateEntity) CreateTyped(reqdata UpdateCreateData, ctrl map[string]any) (Update, error) {
