...
type EditForumTopicEntity struct {
	name    string
...
func NewEditForumTopicEntity(client *core.TelegramBotSDK, entopts map[string]any) *EditForumTopicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EditForumTopicEntity) GetName() string { return e.name }
...
func (e *EditForumTopicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EditForumTopicEntity) Deleted() bool {
	return e.deleted
}


func (e *EditForumTopicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEditForumTopicEntity(e.client, opts)
}

func (e *EditForumTopicEntity) Data(args ...any) any {
...
func (e *EditForumTopicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EditForumTopic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EditForumTopicEntity) DataTyped(data ...EditForumTopic) EditForumTopic {
	if len(data) > 0 {
		return typedFrom[EditForumTopic](e.Data(asMap(data[0])))
	}
	return typedFrom[EditForumTopic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EditForumTopic (all fields
// optional at the wire level).
func (e *EditForumTopicEntity) MatchTyped(match ...EditForumTopic) EditForumTopic {
	if len(match) > 0 {
		return typedFrom[EditForumTopic](e.Match(asMap(match[0])))
	}
	return typedFrom[EditForumTopic](e.Match())
}
...
func (e *EditForumTopicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EditForumTopicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EditForumTopicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EditForumTopicEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EditForumTopicCreateData and returns an EditForumTopic. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EditForumTopicEntity) CreateTyped(reqdata EditForumTopicCreateData, ctrl map[string]any) (EditForumTopic, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EditForumTopic{}, err
	}
	return typedFrom[EditForumTopic](res), nil
}



func (e *EditForumTopicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EditForumTopicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EditForumTopicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
