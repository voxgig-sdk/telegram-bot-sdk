...
type GetUserProfileAudioEntity struct {
	name    string
...
func NewGetUserProfileAudioEntity(client *core.TelegramBotSDK, entopts map[string]any) *GetUserProfileAudioEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetUserProfileAudioEntity) GetName() string { return e.name }
...
func (e *GetUserProfileAudioEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetUserProfileAudioEntity) Deleted() bool {
	return e.deleted
}


func (e *GetUserProfileAudioEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetUserProfileAudioEntity(e.client, opts)
}

func (e *GetUserProfileAudioEntity) Data(args ...any) any {
...
func (e *GetUserProfileAudioEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetUserProfileAudioEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetUserProfileAudioEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *GetUserProfileAudioEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetUserProfileAudioEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetUserProfileAudioEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetUserProfileAudioEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
