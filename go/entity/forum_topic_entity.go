...
func NewForumTopicEntity(client *core.TelegramBotSDK, entopts map[string]any) *ForumTopicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ForumTopicEntity) GetName() string { return e.name }
...
func (e *ForumTopicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ForumTopicEntity) Deleted() bool {
	return e.deleted
}


func (e *ForumTopicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewForumTopicEntity(e.client, opts)
}

func (e *ForumTopicEntity) Data(args ...any) any {
...
func (e *ForumTopicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ForumTopic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ForumTopicEntity) DataTyped(data ...ForumTopic) ForumTopic {
	if len(data) > 0 {
		return typedFrom[ForumTopic](e.Data(asMap(data[0])))
	}
	return typedFrom[ForumTopic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ForumTopic (all fields
// optional at the wire level).
func (e *ForumTopicEntity) MatchTyped(match ...ForumTopic) ForumTopic {
	if len(match) > 0 {
		return typedFrom[ForumTopic](e.Match(asMap(match[0])))
	}
	return typedFrom[ForumTopic](e.Match())
}
...
func (e *ForumTopicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ForumTopicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ForumTopicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ForumTopicEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ForumTopicCreateData and returns an ForumTopic. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ForumTopicEntity) CreateTyped(reqdata ForumTopicCreateData, ctrl map[string]any) (ForumTopic, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ForumTopic{}, err
	}
	return typedFrom[ForumTopic](res), nil
}



func (e *ForumTopicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ForumTopicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ForumTopicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
