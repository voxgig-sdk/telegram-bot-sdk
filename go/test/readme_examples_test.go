...
const testSeed = `map[string]any{"entity": map[string]any{"approve_suggested_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "decline_suggested_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "delete_forum_topic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "edit_forum_topic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "forum_topic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_business_account_gift": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_chat_gift": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_me": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_user_gift": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_user_profile_audio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message_id": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "promote_chat_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "remove_my_profile_photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "repost_story": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_chat_action": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_message_draft": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "set_my_profile_photo": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "unpin_all_forum_topic_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
