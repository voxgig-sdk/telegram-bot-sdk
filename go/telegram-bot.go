...
// instead of `sdk.NewTelegramBotSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *TelegramBotSDK  { return NewTelegramBotSDK(nil) }
func Test() *TelegramBotSDK { return TestSDK(nil, nil) }
