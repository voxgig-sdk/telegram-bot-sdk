...
func (sdk *TelegramBotSDK) OptionsMap() map[string]any {
...
func (sdk *TelegramBotSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TelegramBotSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TelegramBotSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TelegramBotSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TelegramBotSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TelegramBotSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TelegramBotSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TelegramBotSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TelegramBotSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TelegramBotSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
