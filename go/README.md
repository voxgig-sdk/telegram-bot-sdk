...
## Install
```bash
go get github.com/voxgig-sdk/telegram-bot-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/telegram-bot-sdk=../path/to/github.com/voxgig-sdk/telegram-bot-sdk
```
...
```
github.com/voxgig-sdk/telegram-bot-sdk/
...
The root package (`github.com/voxgig-sdk/telegram-bot-sdk`) re-exports everything needed
