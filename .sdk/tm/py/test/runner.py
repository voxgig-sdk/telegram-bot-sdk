...
class TelegramBotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TelegramBotTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TelegramBotTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TelegramBotTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
