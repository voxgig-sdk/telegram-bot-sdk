...
class TelegramBotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TelegramBotTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = TelegramBotTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = TelegramBotTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
