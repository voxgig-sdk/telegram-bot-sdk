...
// TelegramBot SDK utility: graphql
//
...
class TelegramBotGraphql
{
    ...
    // equivalent.
    public static function body(TelegramBotContext $ctx): mixed
    {
    ...
    public static function errors(TelegramBotContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
