...
// TelegramBot SDK utility: fetcher

class TelegramBotFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TelegramBotSDK/1.0)';
    ...
    public static function call(TelegramBotContext $ctx, string $fullurl, array $fetchdef): array
    {
