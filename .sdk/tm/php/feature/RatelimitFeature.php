...
// TelegramBot SDK ratelimit feature
...
class TelegramBotRatelimitFeature extends TelegramBotBaseFeature
{
    ...
    private function _acquire(TelegramBotContext $ctx): void
    {
    ...
    private function _track(TelegramBotContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
