...
// TelegramBot SDK clienttrack feature
...
class TelegramBotClienttrackFeature extends TelegramBotBaseFeature
{
    ...
    public function PostConstruct(TelegramBotContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TelegramBot-SDK';
