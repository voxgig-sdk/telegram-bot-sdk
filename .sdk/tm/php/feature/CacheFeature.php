...
class TelegramBotCacheFeature extends TelegramBotBaseFeature
{
    ...
    private function _through(TelegramBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
