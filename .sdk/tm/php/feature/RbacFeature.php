...
class TelegramBotRbacFeature extends TelegramBotBaseFeature
{
    ...
    private function _required(TelegramBotContext $ctx): ?string
    {
    ...
    private function _reject(TelegramBotContext $ctx, string $required): void
    {
    ...
    private function _track(TelegramBotContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
