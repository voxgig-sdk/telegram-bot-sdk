...
// TelegramBot SDK netsim feature
...
class TelegramBotNetsimFeature extends TelegramBotBaseFeature
{
    ...
    private function _simulate(TelegramBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TelegramBotContext $ctx, array $applied): void
    {
        $client = $this->client;
