...
// TelegramBot SDK metrics feature
...
class TelegramBotMetricsFeature extends TelegramBotBaseFeature
{
    ...
    private function _record(TelegramBotContext $ctx, bool $ok): void
    {
