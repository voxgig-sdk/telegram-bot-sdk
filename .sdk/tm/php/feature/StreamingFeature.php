...
// TelegramBot SDK streaming feature
...
class TelegramBotStreamingFeature extends TelegramBotBaseFeature
{
    ...
    private function _iterate(TelegramBotResult $result): \Generator
    {
    ...
    private function _streamable(TelegramBotContext $ctx): bool
    {
