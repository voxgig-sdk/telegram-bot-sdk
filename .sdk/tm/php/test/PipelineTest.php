...
{
    private static function utility(): TelegramBotUtility
    {
        return new TelegramBotUtility();
    }
    ...
    private static function ctx(array $over = []): TelegramBotContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TelegramBotContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TelegramBotOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TelegramBotError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TelegramBotOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TelegramBotMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TelegramBotOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TelegramBotMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TelegramBotOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TelegramBotMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramBotSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TelegramBotMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = TelegramBotMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TelegramBotSpec([]),
            'response' => null,
            'result' => new TelegramBotResult([]),
        ]);
        [, $err] = TelegramBotMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TelegramBotSpec(['step' => 's']),
            'response' => new TelegramBotResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TelegramBotResult([]),
        ]);
        [, $err] = TelegramBotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramBotSpec(['step' => 's']),
            'response' => new TelegramBotResponse(self::resp(200, ['v' => 1])),
            'result' => new TelegramBotResult([]),
        ]);
        [, $err] = TelegramBotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TelegramBotSpec(['step' => 's']),
            'response' => new TelegramBotResponse(self::resp(200, ['v' => 2])),
            'result' => new TelegramBotResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TelegramBotMakeResponse::call($ctx);
    ...
    {
        $preset = new TelegramBotResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TelegramBotSpec([]),
            'response' => new TelegramBotResponse([]),
            'result' => new TelegramBotResult([]),
        ...
        [$got, $err] = TelegramBotMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TelegramBotResult([])]);
        [, $err] = TelegramBotMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TelegramBotSpec([]), 'result' => null]);
        [, $err] = TelegramBotMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramBotSpec(['step' => 's']),
            'result' => new TelegramBotResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TelegramBotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramBotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TelegramBotSpec(['step' => 's']),
            'result' => new TelegramBotResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TelegramBotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TelegramBotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TelegramBotResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TelegramBotSpec([]),
            'result' => new TelegramBotResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TelegramBotMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramBotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TelegramBotError('boom', 'boom');
        $utility->fetcher = function (TelegramBotContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramBotSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TelegramBotMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TelegramBotContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TelegramBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TelegramBotResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TelegramBotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TelegramBotContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TelegramBotSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TelegramBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TelegramBotResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TelegramBotSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TelegramBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TelegramBotMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TelegramBotMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TelegramBotResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TelegramBotDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TelegramBotResult(['ok' => false])]);
        $this->expectException(TelegramBotError::class);
        TelegramBotDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TelegramBotResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TelegramBotMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TelegramBotMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TelegramBotBaseFeature();
        $b = new TelegramBotBaseFeature();
        TelegramBotFeatureAdd::call($ctx, $a);
        TelegramBotFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TelegramBotBaseFeature
    {
        $f = new TelegramBotBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TelegramBotFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): TelegramBotContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new TelegramBotSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TelegramBotPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        TelegramBotPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TelegramBotResponse(['headers' => null]),
            'result' => new TelegramBotResult([]),
        ]);
        TelegramBotResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TelegramBotResultBody::call($ctx);
