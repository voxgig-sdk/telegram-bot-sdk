...
// TelegramBot SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = TelegramBotOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(TelegramBotOmni::structfix($now, Struct::undef()))
                        !== json_encode(TelegramBotOmni::structfix($val, Struct::undef()))) {
