...
|---|---|---|
| `ts/` | @voxgig-sdk/telegram-bot-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/telegram-bot-sdk \
      --repository voxgig-sdk/telegram-bot-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/telegram-bot-sdk` shows it, and
`npm trust revoke @voxgig-sdk/telegram-bot-sdk --id=<id>` removes it.
