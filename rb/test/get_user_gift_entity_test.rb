...
class GetUserGiftEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_GET_USER_GIFT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def get_user_gift_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_GET_USER_GIFT_ENTID"]
