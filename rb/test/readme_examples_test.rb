...
#      offline in seeded test mode (TelegramBotSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TelegramBot_sdk.rb")
  SDK_CLASS = "TelegramBotSDK"
