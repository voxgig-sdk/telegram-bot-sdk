...
class SendChatActionEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_SEND_CHAT_ACTION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def send_chat_action_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_SEND_CHAT_ACTION_ENTID"]
