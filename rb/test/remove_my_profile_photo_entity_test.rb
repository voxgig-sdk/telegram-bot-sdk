...
class RemoveMyProfilePhotoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_REMOVE_MY_PROFILE_PHOTO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def remove_my_profile_photo_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_REMOVE_MY_PROFILE_PHOTO_ENTID"]
