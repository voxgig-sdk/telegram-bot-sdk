...
class UnpinAllForumTopicMessageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_UNPIN_ALL_FORUM_TOPIC_MESSAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def unpin_all_forum_topic_message_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_UNPIN_ALL_FORUM_TOPIC_MESSAGE_ENTID"]
