...
class DeclineSuggestedPostEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_DECLINE_SUGGESTED_POST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def decline_suggested_post_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_DECLINE_SUGGESTED_POST_ENTID"]
