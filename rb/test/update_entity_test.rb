...
class UpdateEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    cfg = TelegramBotConfig.make_config
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TELEGRAMBOT_TEST_UPDATE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def update_basic_setup(extra)
  ...
  entid_env_raw = ENV["TELEGRAMBOT_TEST_UPDATE_ENTID"]
