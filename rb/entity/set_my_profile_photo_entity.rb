...
class SetMyProfilePhotoEntity
  ...
  def make
    opts = @_entopts.dup
    SetMyProfilePhotoEntity.new(@_client, opts)
  end
  ...
  # @return [SetMyProfilePhoto, Hash] the current SetMyProfilePhoto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SetMyProfilePhoto fields)
  def match_get
  ...
  #
  # @param reqdata [SetMyProfilePhotoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SetMyProfilePhoto, Hash] the created SetMyProfilePhoto; raises TelegramBotError on failure
