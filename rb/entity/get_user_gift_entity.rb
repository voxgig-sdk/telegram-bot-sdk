...
class GetUserGiftEntity
  ...
  def make
    opts = @_entopts.dup
    GetUserGiftEntity.new(@_client, opts)
  end
  ...
  # @return [GetUserGift, Hash] the current GetUserGift data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetUserGift fields)
  def match_get
  ...
  #
  # @param reqdata [GetUserGiftCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetUserGift, Hash] the created GetUserGift; raises TelegramBotError on failure
