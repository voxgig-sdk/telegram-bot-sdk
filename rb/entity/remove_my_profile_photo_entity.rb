...
class RemoveMyProfilePhotoEntity
  ...
  def make
    opts = @_entopts.dup
    RemoveMyProfilePhotoEntity.new(@_client, opts)
  end
  ...
  # @return [RemoveMyProfilePhoto, Hash] the current RemoveMyProfilePhoto data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RemoveMyProfilePhoto fields)
  def match_get
  ...
  #
  # @param reqdata [RemoveMyProfilePhotoCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RemoveMyProfilePhoto, Hash] the created RemoveMyProfilePhoto; raises TelegramBotError on failure
