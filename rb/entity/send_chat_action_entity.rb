...
class SendChatActionEntity
  ...
  def make
    opts = @_entopts.dup
    SendChatActionEntity.new(@_client, opts)
  end
  ...
  # @return [SendChatAction, Hash] the current SendChatAction data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of SendChatAction fields)
  def match_get
  ...
  #
  # @param reqdata [SendChatActionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [SendChatAction, Hash] the created SendChatAction; raises TelegramBotError on failure
