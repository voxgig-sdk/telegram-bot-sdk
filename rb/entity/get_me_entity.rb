...
class GetMeEntity
  ...
  # @return [GetMe, Hash] the current GetMe data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetMe fields)
  def match_get
  ...
  # Create a new GetMe.
  #
  # @param reqdata [GetMeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetMe, Hash] the created GetMe; raises TelegramBotError on failure
