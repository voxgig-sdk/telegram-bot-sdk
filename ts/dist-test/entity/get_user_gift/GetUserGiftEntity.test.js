...
(0, node_test_1.describe)('GetUserGiftEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_user_gift.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != get_user_gift_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_user_gift/GetUserGiftTestData.json');
    ...
    let idmap = transform(['get_user_gift01', 'get_user_gift02', 'get_user_gift03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GetUserGiftEntity.test.js.map