...
(0, node_test_1.describe)('SetMyProfilePhotoEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.SetMyProfilePhoto();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.TELEGRAM_BOT_TEST_LIVE;
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'set_my_profile_photo.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != set_my_profile_photo_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/set_my_profile_photo/SetMyProfilePhotoTestData.json');
    ...
    let idmap = transform(['set_my_profile_photo01', 'set_my_profile_photo02', 'set_my_profile_photo03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_SET_MY_PROFILE_PHOTO_ENTID'];
    ...
    idmap = env['TELEGRAM_BOT_TEST_SET_MY_PROFILE_PHOTO_ENTID'];
...
//# sourceMappingURL=SetMyProfilePhotoEntity.test.js.map