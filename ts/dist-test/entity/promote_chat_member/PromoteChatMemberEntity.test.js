...
(0, node_test_1.describe)('PromoteChatMemberEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.PromoteChatMember();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.TELEGRAM_BOT_TEST_LIVE;
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'promote_chat_member.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TELEGRAM_BOT_TEST_PROMOTE_CHAT_MEMBER_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != promote_chat_member_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/promote_chat_member/PromoteChatMemberTestData.json');
    ...
    let idmap = transform(['promote_chat_member01', 'promote_chat_member02', 'promote_chat_member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_PROMOTE_CHAT_MEMBER_ENTID'];
    ...
    idmap = env['TELEGRAM_BOT_TEST_PROMOTE_CHAT_MEMBER_ENTID'];
...
//# sourceMappingURL=PromoteChatMemberEntity.test.js.map