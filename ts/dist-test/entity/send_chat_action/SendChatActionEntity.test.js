...
(0, node_test_1.describe)('SendChatActionEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'send_chat_action.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != send_chat_action_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/send_chat_action/SendChatActionTestData.json');
    ...
    let idmap = transform(['send_chat_action01', 'send_chat_action02', 'send_chat_action03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_SEND_CHAT_ACTION_ENTID'];
...
//# sourceMappingURL=SendChatActionEntity.test.js.map