...
(0, node_test_1.describe)('MessageIdEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'message_id.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TELEGRAM_BOT_TEST_MESSAGE_ID_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != message_id_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/message_id/MessageIdTestData.json');
    ...
    let idmap = transform(['message_id01', 'message_id02', 'message_id03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_MESSAGE_ID_ENTID'];
...
//# sourceMappingURL=MessageIdEntity.test.js.map