...
(0, node_test_1.describe)('DeleteForumTopicEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.DeleteForumTopic();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.TELEGRAM_BOT_TEST_LIVE;
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'delete_forum_topic.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != delete_forum_topic_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/delete_forum_topic/DeleteForumTopicTestData.json');
    ...
    let idmap = transform(['delete_forum_topic01', 'delete_forum_topic02', 'delete_forum_topic03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_DELETE_FORUM_TOPIC_ENTID'];
    ...
    idmap = env['TELEGRAM_BOT_TEST_DELETE_FORUM_TOPIC_ENTID'];
...
//# sourceMappingURL=DeleteForumTopicEntity.test.js.map