...
(0, node_test_1.describe)('RemoveMyProfilePhotoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'remove_my_profile_photo.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_REMOVE_MY_PROFILE_PHOTO_ENTID'];
