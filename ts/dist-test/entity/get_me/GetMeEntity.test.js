...
(0, node_test_1.describe)('GetMeEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        ...
        const ent = testsdk.GetMe();
        (0, node_assert_1.default)(null != ent);
    });
    (0, node_test_1.test)('basic', async (t) => {
        const live = 'TRUE' === process.env.TELEGRAM_BOT_TEST_LIVE;
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_me.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != get_me_ref01_data);
        // LOAD
        const get_me_ref01_match_dt0 = {};
        const get_me_ref01_data_dt0 = (await get_me_ref01_ent.load(get_me_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != get_me_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_me/GetMeTestData.json');
    ...
    let idmap = transform(['get_me01', 'get_me02', 'get_me03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TELEGRAM_BOT_TEST_GET_ME_ENTID'];
...
//# sourceMappingURL=GetMeEntity.test.js.map