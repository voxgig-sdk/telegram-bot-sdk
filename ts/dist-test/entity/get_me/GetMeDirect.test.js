...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TelegramBotSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.TELEGRAM_BOT_APIKEY,
            server: {
                token: env.TELEGRAM_BOT_SERVER_TOKEN,
            },
        }));
        let idmap = env['TELEGRAM_BOT_TEST_GET_ME_ENTID'];
    ...
    const client = new __1.TelegramBotSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetMeDirect.test.js.map