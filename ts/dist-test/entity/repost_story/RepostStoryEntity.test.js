...
(0, node_test_1.describe)('RepostStoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'repost_story.' + op, live))
                return;
        }
        ...
        repost_story_ref01_data = (await repost_story_ref01_ent.create(repost_story_ref01_data)).data();
        (0, node_assert_1.default)(null != repost_story_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/repost_story/RepostStoryTestData.json');
    ...
    let idmap = transform(['repost_story01', 'repost_story02', 'repost_story03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RepostStoryEntity.test.js.map