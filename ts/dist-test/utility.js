...
function envOverride(m) {
    if ('TRUE' === process.env.TELEGRAM_BOT_TEST_LIVE ||
        'TRUE' === process.env.TELEGRAM_BOT_TEST_OVERRIDE) {
    ...
    m.TELEGRAM_BOT_TEST_EXPLAIN = process.env.TELEGRAM_BOT_TEST_EXPLAIN || m.TELEGRAM_BOT_TEST_EXPLAIN;
    return m;
}
