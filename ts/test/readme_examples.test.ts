...
//     (\`new TelegramBotSDK(...)\` / \`TelegramBotSDK.test(...)\` become
//     \`TelegramBotSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"approve_suggested_post":{"test01":{"id":"test01"}},"decline_suggested_post":{"test01":{"id":"test01"}},"delete_forum_topic":{"test01":{"id":"test01"}},"edit_forum_topic":{"test01":{"id":"test01"}},"file":{"test01":{"id":"test01"}},"forum_topic":{"test01":{"id":"test01"}},"get_business_account_gift":{"test01":{"id":"test01"}},"get_chat_gift":{"test01":{"id":"test01"}},"get_me":{"test01":{"id":"test01"}},"get_user_gift":{"test01":{"id":"test01"}},"get_user_profile_audio":{"test01":{"id":"test01"}},"message":{"test01":{"id":"test01"}},"message_id":{"test01":{"id":"test01"}},"promote_chat_member":{"test01":{"id":"test01"}},"remove_my_profile_photo":{"test01":{"id":"test01"}},"repost_story":{"test01":{"id":"test01"}},"send_chat_action":{"test01":{"id":"test01"}},"send_message_draft":{"test01":{"id":"test01"}},"set_my_profile_photo":{"test01":{"id":"test01"}},"unpin_all_forum_topic_message":{"test01":{"id":"test01"}},"update":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new TelegramBotSDK(...)\` and any
// \`TelegramBotSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+TelegramBotSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/TelegramBotSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
