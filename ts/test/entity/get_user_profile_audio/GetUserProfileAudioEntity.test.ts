...
describe('GetUserProfileAudioEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'get_user_profile_audio.' + op, live)) return
    }
    ...
    assert(null != get_user_profile_audio_ref01_data)
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/get_user_profile_audio/GetUserProfileAudioTestData.json')
